        ...
        <div className='px-4 md:px-14 md:pt-6 lg:pt-2 lg:px-6  '>
          <div className='mt-4 '>
            <section
              className={`${
                showNotification
                  ? 'mb-8 rounded bg-green-light px-4 py-3 flex  sm:flex-row justify-between shadow-sm gap-y-4 text-white'
                  : 'hidden'
              }`}
            >
              ...
              <div className='rounded bg-white shadow-sm  '>
                ...
                <div className='pt-7 pb-5 px-6 '>
                  <div className='flex items-center justify-center gap-x-6 mb-16 flex-wrap gap-y-4 '>
                    <button className='rounded py-2 px-3 bg-purple-light capitalize text-white text-sm font-medium'>
                      discount codes
                    </button>
                    <button className='rounded py-2 px-3  capitalize text-gray-light-2 hover:text-purple-light bg-transparent shadow-md text-sm font-medium'>
                      page views
                    </button>
                    <button className='rounded py-2 px-3  capitalize text-gray-light-2 hover:text-purple-light bg-transparent shadow-md text-sm font-medium'>
                      at the door sale
                  ...
                  <div className='sm:w-3/12 '>
                    <a href='dummy.com' className=''>
                      <div className='text-center py-6 text-purple-light cursor-pointer'>
                        <h5 className='text-sm font-semibold capitalize mb-3'>
                          net sales
                        </h5>
                    ...
                    <div className='grid grid-cols-3 mb-8 '>
                      <div className=''>
                        ...
                        <h1 className='capitalize '>
                          <span className=''>$</span>750.00
                        </h1>
                      </div>
                      <div className=''>
                        <h1 className='capitalize '>online sale</h1>
                        <h1 className='capitalize '>
                          <span className=''>$</span>450.00
                        </h1>
                      </div>
                      <div className=''>
                        <h1 className='capitalize '>offline sale</h1>
                        <h1 className='capitalize '>
                          <span className=''>$</span>300.00
                        </h1>
                      </div>
                    </div>
                    <div className=' h-72 object-contain mb-2'>
                      ...
                      <tr className='h-12 font-semibold'>
                        ...
                        <td className='px-3  border border-gray-100'>
                          <div className='flex flex-wrap'>
                            <span className=''>8/8/19</span>
                            <span className=''> 7:00 PM</span>
                          </div>
                        </td>
                      </tr>
                      <tr className='h-12 font-semibold'>
