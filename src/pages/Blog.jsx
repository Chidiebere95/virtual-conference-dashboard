                ...
                <div className='flex flex-col gap-y-2 flex-1 md:w-full px-6 text-gray-light-2'>
                  <div className='editor__wrapper'>
                    <div className='main__editor__wrapper'>
                      <SimpleMDE onChange={onChangeMarkdown} value={markdown} />
                    </div>
                ...
                <div className='px-6 pb-4'>
                  <div className='flex gap-x-2 items-center mb-2 '>
                    <input
                      ...
                      onChange={handleChange}
                    />
                    <label htmlFor='check'>This will generate this page on www.dygycon.com. Kindly check again to ensure that page content are consistent.</label>
                  </div>
                  <button
                    type='submit'
